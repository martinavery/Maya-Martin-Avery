...
android {
    namespace = "com.example.maya_exam_martin_avery"
    // Keep compileSdk at 35 to avoid pulling in libraries that require API 36 at build-time.
    // (We pin androidx.core in the version catalog accordingly.)
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.maya_exam_martin_avery"
        minSdk = 24
        // targetSdk must be <= compileSdk.
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
